...
//		String sampleMCTSController = "tracks.singlePlayer.advanced.sampleMCTS.Agent";
		...
		String rhNeat = "tracks.singlePlayer.advanced.rhneat.Agent";

		String RHv2 = "RHEA.Agent";

		// Available games:
		String gridGamesPath = "examples/gridphysics/";
        String contGamesPath = "examples/examples/contphysics/";
        String gamesPath;
		String games[];
...
//		ArcadeMachine.runOneGame(game, level1, visuals, rhNeat, recordActionsFile, seed, 0);
...
//			ArcadeMachine.runGames(game, new String[]{level1}, M, rhNeat, null);
//		}
...
//			}
//			ArcadeMachine.runGames(game, levels, M, rhNeat, saveActions? actionFiles:null);
//		}
