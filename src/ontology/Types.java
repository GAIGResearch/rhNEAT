...
public class Types {
    ...
    public static int[][] ALL_ACTIONS = new int[][]{    {KeyEvent.VK_UP, KeyEvent.VK_LEFT, KeyEvent.VK_DOWN,
                                                         KeyEvent.VK_RIGHT, KeyEvent.VK_SPACE, KeyEvent.VK_ESCAPE, KeyEvent.VK_P},
                                                        {KeyEvent.VK_W, KeyEvent.VK_A, KeyEvent.VK_S,
                                                         KeyEvent.VK_D, KeyEvent.VK_SHIFT, KeyEvent.VK_ESCAPE, KeyEvent.VK_P}};

    public static final int AGENT_ACTION_COUNT = 6; // If more actions available to the agent added, increase this
